...
#contact
def contact():
    mess._show(title="Contact Me",message="If you find anything weird or you need any help contact me on 'adityadeshmukh7350@gmail.com'")

#about
def about():
    mess._show(title="About",message="This Attendance System is designed by Aditya Deshmukh")
...
clearButton = tkinter.Button(frame1, text="Clear", command=clear, fg="red", bg="white", width=11, activebackground = "blue", font=('times', 12, ' bold '))
